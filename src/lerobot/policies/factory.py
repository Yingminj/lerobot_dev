...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    if name == "tdmpc":
        ...
        from .act_eef.modeling_act_eef import ACTEEFPolicy

        return ACTEEFPolicy
    elif name == "act_eef_cvae":
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, ACTEEFCVAEConfig):
        from .act_eef_cvae.processor_act_eef_cvae import make_act_eef_cvae_pre_post_processors

        processors = make_act_eef_cvae_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )

    elif isinstance(policy_cfg, ACTEEFConfig):
        from .act_eef.processor_act_eef import make_act_eef_pre_post_processors

        processors = make_act_eef_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
    ...
    elif isinstance(policy_cfg, PatchPolicyConfig):
